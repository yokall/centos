...
yum update -y
yum install -y gitk perl-CPAN perl-core perl-devel firefox dos2unix htop libxml2-devel libxslt-devel openssl-devel expat-devel tree httpd mysql-server mongodb-org
